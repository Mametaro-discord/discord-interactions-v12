...
module.exports.ApplicationCommandPermissionTypes = createEnum([
		null,
		'ROLE',
		'USER'
	]);

module.exports.ApplicationCommandOptionTypes = createEnum([
		null,
		'SUB_COMMAND',
		'SUB_COMMAND_GROUP',
		'STRING',
...
module.exports.MessageButtonStyles = createEnum([
		null,
		'blurple',
		'grey',
		'green',
